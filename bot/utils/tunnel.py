...
"""
HTTPS Tunnel for the MidVox API — Cloudflare Tunnel via pycloudflared.
...
4. Give it a name (e.g. midvox-api) and click Save
...
6. Go to "Published Application Routes" tab → Add a Published Application Routes:
      Subdomain: midvox-api   Domain: yourdomain.com   Service: http://localhost:8000
   (Or use any domain you have on Cloudflare)
7. Paste the token into your .env:
      CF_TUNNEL_TOKEN = "eyJhIjoiX..."
      CF_TUNNEL_URL   = "https://midvox-api.yourdomain.com"
