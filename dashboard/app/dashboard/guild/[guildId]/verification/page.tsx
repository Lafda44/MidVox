    ...
    <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          ...
          <p className="text-neutral-400 mt-1">Set up a gatekeeper system to verify new members.</p>
        </div>
      </div>
        ...
        <div className="lg:col-span-3 space-y-6">
          <div className="bg-[#111111] border border-[#1A1A1A] rounded-[6px] overflow-hidden shadow-xl p-8 space-y-8">
            ...
            <div className="flex items-center justify-between p-6 bg-[#131313] rounded-[6px] border border-[#1A1A1A]">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-neutral-400 mt-1">Enable or disable the verification module.</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="px-4 py-2 rounded-full bg-[#111111] border border-[#1A1A1A] flex items-center gap-2">
            ...
            <div className={cn("grid grid-cols-1 md:grid-cols-2 gap-6 transition-all duration-300", !config.enabled && "opacity-50 pointer-events-none")}>
              ...
              <div className="p-6 bg-[#131313] border border-[#1A1A1A] rounded-[6px] space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-neutral-400 mt-1">Channel where verification happens</p>
                  </div>
                </div>
                <Select
              ...
              <div className="p-6 bg-[#131313] border border-[#1A1A1A] rounded-[6px] space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-neutral-400 mt-1">Role given after verification</p>
                  </div>
                </div>
                <Select
                ...
                >
                  ...
                  <SelectContent className="bg-[#111111] border-[#1A1A1A] max-h-[300px]">
                    <SelectItem value="none" className="text-neutral-400 focus:bg-[#1A1A1A]">Not Set</SelectItem>
                    {filteredRoles.map((r) => (
                      <SelectItem key={r.id} value={r.id} className="focus:bg-[#1A1A1A]">{r.name}</SelectItem>
                    ))}
                  </SelectContent>
                </Select>
              </div>
              ...
              <div className="p-6 bg-[#131313] border border-[#1A1A1A] rounded-[6px] space-y-4">
                <div className="flex items-center gap-3">
                  <div className="p-3 bg-amber-500/20 text-amber-500 rounded-xl"><Fingerprint className="w-5 h-5" /></div>
                  <div>
                    <h4 className="font-bold text-white">Verification Method</h4>
                    <p className="text-xs text-neutral-400 mt-1">How users verify themselves</p>
                  </div>
                </div>
                <Select
                ...
                >
                  ...
                  <SelectContent className="bg-[#111111] border-[#1A1A1A]">
                    <SelectItem value="button" className="focus:bg-[#1A1A1A]">Button Click</SelectItem>
                    <SelectItem value="captcha" className="focus:bg-[#1A1A1A]">CAPTCHA Image</SelectItem>
                    <SelectItem value="both" className="focus:bg-[#1A1A1A]">Both (Combined)</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              ...
              <div className="p-6 bg-[#131313] border border-[#1A1A1A] rounded-[6px] space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-neutral-400 mt-1">Where verification logs are sent</p>
                  </div>
                </div>
                <Select
                ...
                >
                  ...
                  <SelectContent className="bg-[#111111] border-[#1A1A1A] max-h-[300px]">
                    <SelectItem value="none" className="text-neutral-400 focus:bg-[#1A1A1A]">Disabled</SelectItem>
                    {textChannels.map((c) => (
                      <SelectItem key={c.id} value={c.id} className="focus:bg-[#1A1A1A]">#{c.name}</SelectItem>
                    ))}
                  </SelectContent>
